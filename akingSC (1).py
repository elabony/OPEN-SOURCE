...
----------------------------------------------
 Author    : EMoN Vaii
 Github    : elabony
 Facebook  : MD. Emon Ali
 Tool Name : King Emon
 Type type : PAID
 Version   : 1.9.8
----------------------------------------------
 Emon vai Pro version 1.9.8
 For Haters:Amr loge lagte aiso na bajan voira dimu\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
        os.system('clear')
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [Emon-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
